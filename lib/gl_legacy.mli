...
(** [The gl-legacy] library is a minimal set of OCaml bindings to the venerable
    ...
    mode. In particular, it includes {e Display Lists}, and the interesting
    {e Feedback mode}.
...
(** {2 OpenGL functions}
    ...
    {e If you don't find a function below, it is maybe because it still exists
       ...
       {{:https://erratique.ch/software/tgls/doc/index.html}tgls}.} For instance
    if you want to use OpenGL 3.x you should consult:
